      ...
      <div className="space-y-6 animate-in fade-in">
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <input type="date" value={startDate} onChange={(e) => { setStartDate(e.target.value); setDateShortcut(undefined as any); }} className="text-xs border border-gray-200 rounded px-2 py-1 focus:border-brand-orange outline-none" />
            <span className="text-gray-300">-</span>
            <input type="date" value={endDate} onChange={(e) => { setEndDate(e.target.value); setDateShortcut(undefined as any); }} className="text-xs border border-gray-200 rounded px-2 py-1 focus:border-brand-orange outline-none" />
        ...
        {!filterByParentId && (
          <div className="bg-white p-4 rounded-3xl border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <input type="date" value={startDate} onChange={(e) => { setStartDate(e.target.value); setDateShortcut(undefined as any); }} className="text-xs border border-gray-200 rounded-xl px-3 py-2 outline-none focus:border-brand-orange bg-gray-50 font-bold text-slate-600" />
              <span className="text-gray-300 font-bold">-</span>
              <input type="date" value={endDate} onChange={(e) => { setEndDate(e.target.value); setDateShortcut(undefined as any); }} className="text-xs border border-gray-200 rounded-xl px-3 py-2 outline-none focus:border-brand-orange bg-gray-50 font-bold text-slate-600" />
              <div className="flex items-center gap-1 ml-2">
                {[{ key: 'yesterday', label: 'Ontem' }, { key: 'today', label: 'Hoje' }, { key: 'tomorrow', label: 'Amanhã' }].map(opt => {
                  const getDateForShortcut = (k: string) => {
                    const d = new Date();
