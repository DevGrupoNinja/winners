  ...
  return (
    <div className="h-full flex flex-col space-y-8 animate-in fade-in duration-700 overflow-y-auto custom-scrollbar pb-12 pr-2">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm group hover:shadow-xl transition-all duration-300 cursor-pointer" onClick={() => onNavigate('ATHLETES')}>
        ...
        <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm group hover:shadow-xl transition-all duration-300 cursor-pointer" onClick={() => onNavigate('CYCLES')}>
          <div className="flex justify-between items-start mb-4">
        ...
        <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm group hover:shadow-xl transition-all duration-300 cursor-pointer" onClick={() => onNavigate('TRAINING')}>
          <div className="flex justify-between items-start mb-4">
        ...
        <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm group hover:shadow-xl transition-all duration-300 cursor-pointer" onClick={() => onNavigate('COMPETITIONS')}>
          <div className="flex justify-between items-start mb-4">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white rounded-[40px] border border-slate-100 shadow-xl overflow-hidden">
            <header className="p-8 border-b border-slate-50 bg-slate-50/30 flex justify-between items-center">
              ...
              <button onClick={() => onNavigate('CYCLES')} className="text-xs font-black text-brand-orange uppercase tracking-widest hover:underline flex items-center gap-1">Plano Completo <ChevronRight size={14}/></button>
            </header>
            <div className="p-8">
            ...
            <div className="bg-brand-slate rounded-[32px] p-8 text-white relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-6 border-t border-white/10">
                  ...
                  <button onClick={() => onNavigate('COMPETITIONS')} className="px-6 py-3 bg-white text-brand-slate rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange hover:text-white transition-all shadow-xl">Painel do Evento</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[40px] border border-slate-100 shadow-xl p-8 flex flex-col h-full min-h-[500px]">
            ...
            <div className="space-y-8 flex-1">
              <div className="space-y-4">
                ...
                <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 group hover:border-brand-orange/30 transition-all cursor-pointer" onClick={() => onNavigate('TRAINING')}>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 group hover:border-brand-orange/30 transition-all cursor-pointer" onClick={() => onNavigate('GYM')}>
                  <div className="flex justify-between items-start mb-3">
